...
public class SymbolTable {
     ...
     */
    /*
     * Kenthor - this is totally buggy !
     * In case of an empty <Ind></Ind>, which will result in a symbol search for "",
     * this leads to a crash in the RuleEngine as the statement above DOES NOT HOLD then !
     * 
     * Changing the INOSYM content to 'null'
     */
    // public static final int INOSYM = internSymbol("");
    public static final int INOSYM = internSymbol(null);
