...
public class Types {
    ...
    public static int createDAGNode(String name) {
            ...
            //log.warn("Type " + name + " already exists, cannot create type definition.");
    ...
    public static int createType(String name, String[] parents) {
        ...
        if (parents.length > 0) {
            ...
            for (int i = 0; i < parents.length; i++) {
                ...
                if (id == -1) {
                    //log.warn("Type " + parents[i] + " not defined, cannot create sub-type.");
 ...
 */
    ...
    public static int createDAGEdges(String name, String[] parents) {
        ...
        if (types.contains(name)) {
            //log.warn("Type " + name + " already exists, creating DAG edges.");
            }
