 ...
 *
 * The call format is lessThan(?var, input).
 *
 * <p>Title: OO jDREW</p>
 *
 ...
 * @version 0.89
 */
public class LessThanBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("lessThan");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-lt-"
                                                      + p1s + "<" + p2s),
