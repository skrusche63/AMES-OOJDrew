 ...
 *
 * The call format is lessThanOrEqual(?var, input).
 *
 ...
 * @version 0.89
 */
public class LessThanOrEqualBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("lessThanOrEqual");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-lte-"
                                                      + p1s + "<=" + p2s),
