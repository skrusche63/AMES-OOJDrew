 ...
 *
 * Calling format equal(input1, input2).
 * 
 ...
 * @version 0.89
 */
public class EqualBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("equal");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-equals-"
                                                      + p1s + "-" + p2s),
